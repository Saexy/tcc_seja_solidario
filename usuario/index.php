            ...
            <nav class="navbar navbar-expand-lg navbar-light background-branco">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        if(isset($_COOKIE['logadodoador']) || isset($_COOKIE['logadodonatario'])){
                            if(isset($_COOKIE['logadodoador']) && $_COOKIE['logadodoador'] == 'sim'){
                                ?>

                                <li class="nav-item">
                                    <a class="nav-link" href="?p=doador/doacao"><i class="material-icons align-middle">card_giftcard</i> Faça sua doação</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#doacao"><i class="material-icons align-middle">support</i> Pedir doação</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="?p=logout"><i class="material-icons align-middle">logout</i> Sair</a>
                                </li>
